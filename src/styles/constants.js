...
const COLORS = {
  NEUTRAL: {
    ...
    MYSTIC_200: 'hsl(230, 45%, 97%)',
    MYSTIC_300: 'hsl(230, 40%, 94%)',
    MYSTIC_400: 'hsl(230, 35%, 90%)',
    MYSTIC_500: 'hsl(230, 30%, 84%)',
    MYSTIC_600: 'hsl(230, 23%, 75%)',
    MYSTIC_700: 'hsl(235, 18%, 64%)',
    MYSTIC_800: 'hsl(235, 12%, 52%)',
